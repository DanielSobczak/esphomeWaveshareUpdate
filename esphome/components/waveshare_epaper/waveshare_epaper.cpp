...
// Slow-refresh LUTs for WaveshareEPaper7P5InBV3 (42-byte format, 5 tables)
static const uint8_t LUTC_SLOW_7P5BV3[42] = {
    0x0, 0xF, 0xF, 0x0, 0x0, 0x1, 0x0, 0xF, 0x1, 0xF, 0x1, 0x2, 0x0, 0xF, 0xF, 0x0, 0x0, 0x1, 0x0, 0x0, 0x0,
    0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
};
static const uint8_t LUTWW_SLOW_7P5BV3[42] = {
    0x10, 0xF, 0xF, 0x0, 0x0, 0x1, 0x84, 0xF, 0x1, 0xF, 0x1, 0x2, 0x20, 0xF, 0xF, 0x0, 0x0, 0x1, 0x0, 0x0, 0x0,
    0x0,  0x0, 0x0, 0x0, 0x0, 0x0, 0x0,  0x0, 0x0, 0x0, 0x0, 0x0, 0x0,  0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
};
static const uint8_t LUTBW_SLOW_7P5BV3[42] = {
    0x10, 0xF, 0xF, 0x0, 0x0, 0x1, 0x84, 0xF, 0x1, 0xF, 0x1, 0x2, 0x20, 0xF, 0xF, 0x0, 0x0, 0x1, 0x0, 0x0, 0x0,
    0x0,  0x0, 0x0, 0x0, 0x0, 0x0, 0x0,  0x0, 0x0, 0x0, 0x0, 0x0, 0x0,  0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
};
static const uint8_t LUTWB_SLOW_7P5BV3[42] = {
    0x80, 0xF, 0xF, 0x0, 0x0, 0x3, 0x84, 0xF, 0x1, 0xF, 0x1, 0x4, 0x40, 0xF, 0xF, 0x0, 0x0, 0x3, 0x0, 0x0, 0x0,
    0x0,  0x0, 0x0, 0x0, 0x0, 0x0, 0x0,  0x0, 0x0, 0x0, 0x0, 0x0, 0x0,  0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
};
static const uint8_t LUTBB_SLOW_7P5BV3[42] = {
...
void WaveshareEPaper7P5InBV3::init_display_() {
  ...
  if (this->fast_refresh_) {
    ...
    for (count = 0; count < 42; count++)
      this->data(LUTC_SLOW_7P5BV3[count]);

    this->command(0x21);  // LUTWW
    for (count = 0; count < 42; count++)
      this->data(LUTWW_SLOW_7P5BV3[count]);

    this->command(0x22);  // LUTBW
    for (count = 0; count < 42; count++)
      this->data(LUTBW_SLOW_7P5BV3[count]);

    this->command(0x23);  // LUTWB
    for (count = 0; count < 42; count++)
      this->data(LUTWB_SLOW_7P5BV3[count]);

    this->command(0x24);  // LUTBB
    for (count = 0; count < 42; count++)
      this->data(LUTBB_SLOW_7P5BV3[count]);
  }
};
